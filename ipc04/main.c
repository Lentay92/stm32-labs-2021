...
void *thread_two(void *arg)
{
  ...
  int flash_duration = 1000000;
  for (int i = 0; i < msg_avail(); ++i)
  {
      if (flash_duration == 100000)
        flash_duration = 1000000;
      flash_duration -= 100000;
  }
